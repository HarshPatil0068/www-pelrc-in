...
const sendEmail = async ({ name, email, phone, preferredDate }) => {
 ...
 await transporter.sendMail({
  ...
  html: `
    <div style="font-family: 'Segoe UI', Tahoma, sans-serif; max-width: 650px; margin: 0 auto; background-color: #ffffff; border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); padding: 30px; border: 1px solid #e0e0e0;">
      
      <h2 style="color: #d4af37; text-align: center; margin-bottom: 20px; border-bottom: 1px solid #ddd; padding-bottom: 10px;">
      ...
      <div style="margin-top: 30px;">
        ...
        <div style="background-color: #f8f8f8; padding: 15px 20px; border-left: 4px solid #d4af37; border-radius: 4px; color: #555; line-height: 1.6;">
          I would like to register for this Web Development Internship. Please provide further details.
        </div>
      </div>
