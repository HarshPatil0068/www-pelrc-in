...
const { sendEnquiryMessage } = require("./controller/inquiryFormController.js");
...
app.get("/cncProgrammingInternship", (req, res) => {
  res.render("cncProgrammingInternship");
});
...
app.get("/logout", (req, res) => {
  ...
  res.redirect("/?logout=success"); // or wherever you want to send the user
});
